-- Migración: Validaciones en Base de Datos
...
-- Esto se hace con una función de validación
...
CHECK (
  ...
  (
    metodo_pago IN ('Efectivo', 'Transferencia', 'Tarjeta') OR
...
-- ============================================
-- 7. VISTA PARA ESTADÍSTICAS
-- ============================================

-- Crear vista que funcione con cualquier estructura (id o identificacion)
DO $$
BEGIN
  ...
  IF EXISTS (
    ...
    FROM public.ventas';
  ELSE
    -- Si no existe 'id', usar 'identificacion'
    EXECUTE '
    CREATE OR REPLACE VIEW ventas_estadisticas AS
    SELECT 
